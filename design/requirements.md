...
## Note: the minispecsdom readers moved out on 2026-09-14

The nine features that owned R210–R355 (less the sdom numbers among them: R222–R225, R257, R290–R297, R299, R309–R310, R346–R350, R353) — traceability comment, part line, and the carve, pending, done, current, test-design, gaps and requirements schemas — moved to mini-spec's `tool/internal/minispecsdom` with their specs and design, renumbered there (mini-spec's `carves/minispecsdom-move.md`). The numbers are a hole here on purpose: never reuse them.
