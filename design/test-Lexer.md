# Test Design: Lexer
**Source:** crc-Lexer.md, crc-BracketGroup.md
...
**Refs:** crc-Lexer.md, seq-scan.md#1.5
**Code:** sdom/lexer_test.go
...
`Separator`
**Refs:** crc-Lexer.md, seq-scan.md#1.3.3
**Code:** sdom/lexer_test.go
...
**Refs:** crc-Lexer.md, seq-scan.md#3.1
**Code:** sdom/lexer_test.go
**Alarm:** 2
...
**Refs:** crc-Lexer.md, seq-scan.md#3.2
**Code:** sdom/lexer_test.go
...
**Refs:** crc-Lexer.md, seq-scan.md#3.4
**Code:** sdom/lexer_test.go
...
## Test: nothing inside a scan-restricted group is tokenized
...
byte survives
**Refs:** crc-Lexer.md, crc-BracketLang.md
**Code:** sdom/lexer_test.go
