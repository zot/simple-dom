...
**Pulled:** 2026-09-02 — re-pulled after Item 6.1's retype and rang: nine failures across six schema tests, every name rendering with its whitespace (`func[ Index]`, `func[ foo ]`, `func[\nfoo]`); the `sdom` package stayed green, as the prose predicts. Previously 2026-08-31 — rang: `func[ Index]` against `func[Index]`, the leading
...
**Pulled:** 2026-09-02 — re-pulled after Item 6.1's retype and rang: `got <nil>, want ErrDeclarationsStale` in `TestStaleDeclarationsRefuse`, **and** in `TestDeclarationNamesAreTheDocumentsOwnNodes`, written tonight — the new coverage lands where this alarm already pointed. Previously 2026-08-31 — **re-pulled** after the index consolidation rewrote this
...
**Pulled:** 2026-09-02 — re-pulled after Item 6.1's retype and rang: `got 0 names after a rebuild, want 1`, only that test, `sdom/schema` green. Previously 2026-08-31 — rang: *got 0 names after a rebuild, want 1 — a silent wipe
...
**Inject:** sdom/context.go:BracketContext.SetDeclarations
**Pulled:** 2026-09-02 — re-pulled after Item 6.1's retype and rang: `a keyword absent from the second call kept 1 names`, only that test. Previously 2026-08-31 — rang: *a keyword absent from the second call kept 1 names;
